/**
 * @file TestBP6DEneTabIOCG.cpp
 * @author Klark Chen (klarkchen@ustc.edu.cn)
 * @brief test IO performance of BasePair6DEnergyTableCG with txt and binary data sources.
 * @version 0.1
 * @date 2024-01-11
 * 
...
int main() {
    ...
    gettimeofday(&start, NULL);
    auto* set2 = new BasePair6DEnergyTableCG(para, false);
    gettimeofday(&end, NULL);
