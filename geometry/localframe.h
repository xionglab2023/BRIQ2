...
inline LocalFrame generateLocalFrameResidueStyle(const XYZ& n, const XYZ& ca, const XYZ& c){
	...
	XYZ y = ~(z^x);
	return LocalFrame(ca, x, y, z);
}

/*
inline LocalFrame generateLocalFrameBBNStyle(const XYZ& n, const XYZ& ca, const XYZ& c){
