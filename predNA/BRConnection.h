...
#ifndef predNA_BRCONNECTION_H_
#define predNA_BRCONNECTION_H_
...
public:
	...
	RiboseRotamer* childRot;
	RiboseRotamer* childRotTmp;
	...
	void printChildConnections() {
		for(unsigned int i=0;i<childConnectionList.size();i++) {
